...
<div class="main">
    ...
    <form action="/todo/outbound/admin/searchWarehouse" method="get" style="display: flex; gap: 8px;">
    ...
    <form action="/todo/outbound/admin/searchDate" method="get" style="display: flex; gap: 8px;">
