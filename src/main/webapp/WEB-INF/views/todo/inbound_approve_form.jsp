...
<div class="main">
    ...
    <div>
        <form action="/todo/inbound/update" method="post">
            <input type="number" name="inbound_id" placeholder="승인할 입고 ID" required style="padding: 6px 8px; font-size: 12px; border-radius: 6px; border: 1px solid #ccc;"><br>
            <button type="submit" style="background-color: #0053a0; color: white; border: none; padding: 6px 12px; border-radius: 6px; font-size: 12px; cursor: pointer;">입고 승인</button>
        </form>
    </div>
